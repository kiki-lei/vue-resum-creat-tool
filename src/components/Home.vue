  ...
  <div class="demo-grid">
    <mu-row>
      <mu-col width="100" tablet="30" desktop="25" class="resume-left">
          ...
          <!-- 个人基本信息 -->
          <div class="baseInfo">
              <mu-text-field hintText="输入年龄" type="type" icon="face" fullWidth />
              <mu-text-field hintText="输入住址" type="type" icon="place" fullWidth />
              <mu-text-field hintText="输入电话号码" type="type" icon="phone" fullWidth />
              <mu-text-field hintText="输入邮箱" type="type" icon="mail" fullWidth />
          </div>
...
.baseInfo .mu-text-field-icon,
.baseInfo .mu-text-field-input,
.baseInfo .mu-text-field.has-label .mu-text-field-label.float,
.baseInfo .mu-text-field-hint {
  color: #ffffff;
}
.resume-right {
  padding: 2%;
